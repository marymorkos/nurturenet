...
.hero-title { font-family: "DM Serif Display", serif; font-size: 3.2rem; color: #ffffff !important; margin: 0 0 6px 0; font-weight: 700; text-shadow: 0 2px 16px rgba(0,0,0,0.5); letter-spacing: -1px; line-height: 1; }
